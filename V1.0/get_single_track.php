...
if(isset($_REQUEST['user_id']) && $_REQUEST['user_id'] != '' && isset($_REQUEST['track_id']) && $_REQUEST['track_id'] != '')
{
    ...
    if($sel->num_rows > 0)
    {
        ...
        //playlist status
        $sel_playlist = $con->query("SELECT * FROM tbl_playlist_track WHERE user_id='".$_REQUEST['user_id']."' AND track_id='".$_REQUEST['track_id']."'");
        ...
        //mistake status
        $mistake_track = $con->query("SELECT * FROM tbl_mistake_track WHERE user_id='".$_REQUEST['user_id']."' AND track_id='".$_REQUEST['track_id']."'");
