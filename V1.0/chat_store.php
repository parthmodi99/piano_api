...
if (isset($_REQUEST['user_id']) && $_REQUEST['user_id'] != '') {
    ...
    if ($user->num_rows > 0) {
        ...
        // $new_value = str_replace("'", "''", $_REQUEST['message']);
        
        $add_chat = $con->query("INSERT INTO tbl_chat(`from_id`,`to_id`,`sent_by`,`is_read`,`message`) VALUES('".$_REQUEST['user_id']."','".$admin_id."','1','1','".mysqli_real_escape_string($con,$_REQUEST['message'])."')");
        ...
        if ($add_chat) {
            ...
            $mail->isHTML(true);
            $mail->Subject = "Message from ".$user_data['name']."";
            ...
            <body>
                ...
                <table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="mobile-width" bgcolor="#ffffff" style="padding:25px 6%; ">
                    <tbody>
                        <tr>
                            <td align="left">   
                                <h3 style="font-family: Arial;color:#515151;">Message : </h3>
                                <h4><b>'.$_REQUEST['message'].'</b></h4>
